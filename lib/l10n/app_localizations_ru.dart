...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get languageSpanishPicker => 'Испанский (Español)';

  @override
  String get languageArabicPicker => 'Арабский (العربية)';

  @override
  String get languageFrenchPicker => 'Французский (Français)';

  @override
  String get languageBengaliPicker => 'Бенгали (বাংলা)';

  @override
  String get languagePortuguesePicker => 'Португальский (Português)';

  @override
  String get languageRussianPicker => 'Русский (Русский)';

  @override
  String get languageUrduPicker => 'Урду (اردو)';

  @override
  String get languageMandarinPicker => 'Китайский (中文)';

  @override
  String get languageTamilPicker => 'Тамильский (தமிழ்)';

  @override
  String get languageHindiPicker => 'Хинди (हिन्दी)';

  @override
  String get languageTeluguPicker => 'Телугу (తెలుగు)';

  @override
  String get languageTutorialTitle => 'Выберите язык';

  @override
  String get languageTutorialBody =>
      'Нажмите кнопку языка, чтобы в любой момент сменить язык приложения.';
