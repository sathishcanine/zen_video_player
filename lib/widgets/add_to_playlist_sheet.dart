...
/// Picker to add one or more video asset IDs to a playlist.
Future<void> showAddToPlaylistSheet(
  ...
  var playlists = await PlaylistService.loadAll();
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          ...
                          if (name == null) return;
                          final created = await PlaylistService.create(name);
                          await PlaylistService.addAssets(
                            created.id,
                            assetIds,
                          );
                          if (ctx.mounted) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  l10n.addedToPlaylist(created.name),
                                ),
                              ),
                            );
                          }
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return ListTile(
                          ...
                          onTap: () async {
                            await PlaylistService.addAssets(p.id, assetIds);
                            if (ctx.mounted) {
                              Navigator.pop(ctx);
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
